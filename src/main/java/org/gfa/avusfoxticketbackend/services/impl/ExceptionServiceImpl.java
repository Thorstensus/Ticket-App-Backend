...
public class ExceptionServiceImpl implements ExceptionService {
    ...
    @Autowired
    public ExceptionServiceImpl(HttpServletRequest httpServletRequest, UserRepository userRepository, PasswordEncoder passwordEncoder) {
    ...
    public void handleRegisterErrors(RequestUserDTO requestDto) {
        if (requestDto == null) {
            ...
            throwPassRequired();
                ...
                || !(isValidEmailRequest(requestDto.getEmail()))) {
            throwInvalidMail();
    ...
    public void throwNameEmailPassRequired(){
        throw new ApiRequestException(httpServletRequest.getRequestURI(), "Name, email and password are required.");
    }
    ...
    public void throwPasswordTooShort(){
        throw new ApiRequestException(httpServletRequest.getRequestURI(), "Password must be at least 8 characters.");
    }
    ...
    public void throwEmailOrPasswordIncorrect() {
        throw new ApiRequestException(httpServletRequest.getRequestURI(), "Email or password is incorrect.");
    }
